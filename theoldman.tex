...
\documentclass[fontset=ubuntu]{ctexrep}
...
\newcommand{\dingphotoh}[6] {
  \begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\textwidth]{fish/#1}
    \caption{#2}\label{fig:#1}
    \raggedright\small #3
    \vfill \vspace{1cm}
    \centering
    \includegraphics[width=0.8\textwidth]{fish/#4}
...
\chapter*{《老人与海》中出现的鱼}
\addcontentsline{toc}{chapter}{《老人与海》中出现的鱼}

参考自豆瓣 cocojamboo所写文章。

\url{https://book.douban.com/subject/1064275/discussion/616533832/}

\dingphotoh{marlin}{marlin, 枪鱼，马林鱼}{老人捕获的马林鱼身长十八尺（5.48米），体
  重一千五百磅（680公斤）}{tuna}{tuna, 金枪鱼}{活跃而敏捷的食肉动物，拥有光滑
  的流线型身体，也是游动速度最快的远洋鱼类之一。}

\dingphotoh{dolphin}{dolphin, 鲯鳅}{体较大且延长侧扁，前部高大，向后渐变细。
  头大，背部很窄，成鱼头背几呈方形，额部有一骨质隆起，随成长而越明显，尤以雄
  鱼为甚。}{flying}{flying fish, 飞鱼}{体态修长，稍稍侧扁，长度一般为45厘米。吻短，口小，眼大。胸鳍发达如翼，腹鳍也比较发达，尾鳍的下叶要比上叶长。由尾部迅速摆动，可达到极大的速度，然后跃出水面，张开胸鳍，可滑行百米以上的距离。}
...
\addcontentsline{toc}{chapter}{The Old Man and the Sea}
...
\gls{skiff} empty and he always went down to help him carry \uline{either} the
\gls{coiled} lines \uline{or}\footnote{either \ldots{} or, 或者……或者……，要
  么……要么……} the \gls{gaff} and \gls{harpoon} and the \gls{sail} that was
\gls{furled} around the \gls{mast}. The \gls{sail} was patched with flour
\glspl{sack} and, \gls{furled}, it looked like the flag of \gls{permanent} defeat.

The old man was thin and \gls{gaunt} with deep \glspl{wrinkle} in the back
of his neck. The brown \glspl{blotch} of the benevolent \gls{skin} cancer the sun
\glspl{bring} from its \gls{reflection} on the tropic sea were on his cheeks. The
blotches ran well down the sides of his face and his hands had the
\gls{deep-creased} \glspl{scar} from handling heavy fish on the
\glspl{cord}. But none of these scars were fresh. They were \gls{as} old as
\glspl{erosion} in a fishless desert\footnote{无鱼沙漠中的侵蚀。将伤疤与无鱼
  沙漠侵蚀联系在一起。无鱼沙漠对应捕鱼人的身份，突出其凄凉。}.
...
``I remember,'' the old man said. ``I know you did not leave me because you \gls{doubted}.''
...
and the \gls{steady} good weather and of what they had seen. The successful
fishermen of that day were already in and had \gls{butchered} their
\gls{marlin} out and carried them \gls{laid} full length across two \glspl{plank},
with two men staggering at the end of each plank, to the fish house
where they waited for the ice truck to carry them to the market in Havana.
Those who had caught \glspl{shark} had taken them to the \gls{shark} factory
on the other side of the \gls{cove} where they were \gls{hoisted} on a
\gls{block} and \gls{tackle}, their \glspl{liver} removed, their \gls{fins}
...
``Yes,'' the old man said. He was holding his glass and \textbf{thinking of} many years ago.
...
the \gls{bow} where the wet \gls{coiled} lines were and feeling the whole boat \gls{shiver}
...
``I remember everything \uline{from when} we first went together.''
...
``May I get the \gls{sardines}? I know where I can get four \glspl{bait} too.''
...
``Thank you,'' the old man said. He was too simple to \gls{wonder} when he
had \gls{attained} \gls{humility}. But he knew he had \gls{attained} it and he knew it
was not \gls{disgraceful} and it carried no loss of true \gls{pride}.
...
They picked up the \gls{gear} from the boat. The old man carried the
mast on his \gls{shoulder} and the boy carried the wooden boat with
the coiled, hard-\gls{braided}\footnote{复合词。hard在这里作“坚实的，牢固
  的”。因为名词短语中的前置修饰语部分只容单个功能词位置，所以将两词
  用 hyphen - 连接复合。“牢固编织的”} brown lines, the \gls{gaff} and the
harpoon with its \gls{shaft}. The box with the baits was under the
\gls{stern} of the \gls{skiff} along with the club that was used to
\gls{subdue} the big fish when they were brought \gls{alongside}. No one
would \gls{steal} from the old man but it was better to take the \gls{sail}
and the heavy lines home as the \gls{dew} was bad for them and, though he
was quite sure no local people would steal from him, the old man thought
that a gaff and a harpoon were \gls{needless} \glspl{temptation} to leave in
a boat.

They walked up the road together to the old man's \gls{shack} and \uline{went
  in} \uline{through its open door}. The old man \gls{leaned} the mast
with its \gls{wrapped} sail \gls{against} the wall and the boy put the box
and the other gear beside it. The mast was \gls{nearly} as long
as\footnote{as long as: 一直，整个时间里；只要。} the one room of the shack.
The shack was made of the \gls{tough} \gls{budshields} of the \gls{royal_palm} which are called guano\footnote{royal palm的西班牙语。} and in it
there was a bed, a table, one chair, and a place on the dirt floor to cook
with \gls{charcoal}. On the brown walls of the \gls{flattened},
\gls{overlapping} leaves of the \gls{sturdy} \gls{fibered} guano there was a
\gls{picture} in color of the Sacred Heart of Jesus\footnote{耶稣圣心图} and
another of the Virgin of Cobre\footnote{科布莱圣母图}. These were
\glspl{relic} of his wife. Once there had been a \gls{tinted} photograph of
his wife on the wall but he had taken it down because it made him too lonely
to see it and it was on the shelf in the corner \uline{under his clean
  shirt}.\footnote{这句建议细加品味。}
...
see me bring one in that \gls{dressed_out} over a thousand pounds\footnote{that关系
...
``Perico gave it to me at the bodega\footnote{bodega, \doulos{bәʊˈdiːɡә}，
...
Terrace. The two \gls{sets} of knives and forks and spoons were in his pocket with
...
\gls{two streets down the road}. I must have water here for him, the boy
...
``I wanted to take him fishing but I was too \uline{timid} to ask him. Then I
...
``Because he came here the most times,'' the old man said. ``If Durocher had continued to come here each year your father would \uline{think him the greatest manager}.''
...
``Que Va\footnote{西班牙语，“干嘛这么说”},'' the boy said. ``There are
...
``You ought to go to bed now so that you will be \gls{fresh} in the morning. I will take the things back to the Terrace.''
...
peaks of the Islands rising from the sea and then he dreamed of the
different harbours and roadsteads of the Canary Islands.
...
walked in quietly with his \gls{bare} feet. The boy was asleep on a
...
``\emph{Qu\'e Va},'' the boy said. ``It is what a man must do.''
...
the \gls{furled} sail on his shoulder.
...
knew that he should take it. For a long time now eating had bored\footnote{根
  据had，这里的bored是bore的过去分词，作“烦人的状况”；不是作为形容词使用
  的“某人对某人/某事无聊或厌烦”。} him and he never carried a lunch. He
had a bottle of water in the \gls{bow} of the skiff and that was all he
needed for the day.
...
``Good luck,'' the old man said. He fitted the rope lashings\footnote{把绳子
  绑扎好。} of the
\glspl{oar} onto the \gls{thole} \glspl{pin} and, \gls{leaning} forward
against the \gls{thrust} of the \glspl{blade} in the water, he began to row
out of the harbour in the dark. There were other boats from the other
beaches going out to sea and the old man heard the \gls{dip} and push of
their oars even though he could not see them now the moon was below the
hills.
...
were out of the mouth of the harbour and each one headed for the part of
the ocean where he hoped to find fish. The old man knew he was going far
out and he left the smell of the land behind and rowed out into \uline{the
  clean early morning smell of the ocean}. He saw the \gls{phosphorescence}
of the Gulf weed in the water as he rowed over the part of the ocean that
the fishermen called the great well because there was a \gls{sudden} deep
of seven hundred \glspl{fathom} where all sorts of fish \gls{congregated}
because of the \gls{swirl} the current made against the steep walls of the
floor of the ocean. Here there were \glspl{concentration} of \gls{shrimp} and
\gls{bait} fish and sometimes \glspl{school} of \gls{squid} in the deepest
holes and these \gls{rose} \gls{close_to} the \gls{surface} at night where
all the \gls{wandering} fish fed on them\footnote{fed on them, 以他们为
  食。fed, feed的过去式，喂养，饲养。}.
...
Why did they make birds so delicate and fine as those sea \gls{swallows}
when\footnote{这里的when是 “in view of the fact that; considering that: 既然；
  考虑到”的意思，不是“什么时候”。} the ocean can be so cruel?
...
things of her but they are always said as though she were a woman. Some of
the younger fishermen, those who used \glspl{buoy} as \glspl{float} for their
lines and had motorboats, bought when the shark livers had brought much
money, spoke of her as \emph{el mar} which is \gls{masculine}. They spoke of
her as a \gls{contestant} or a place or even an \gls{enemy}. But the old man
always thought of her as \gls{feminine} and as something that gave or
\gls{withheld} great \glspl{favour}, and if she did wild or \gls{wicked} things it
was because she could not help them. The moon \glspl{affect} her as it does a
woman, he thought.
...
and the third and fourth were down in the blue water at one hundred and one
hundred and twenty-five fathoms. Each bait \gls{hung} head down with the
\gls{shank} of the hook inside the bait fish, \gls{tied} and \gls{sewed}
\gls{solid} and all the \gls{projecting} part of the hook, the \gls{curve}
and the point, was covered with fresh sardines. Each sardine was hooked
through both eyes so that they made a half-\gls{garland} on the projecting
\gls{steel}. There was no part of the hook that a great fish could feel
...
big pencil, was looped onto a green-sapped \gls{stick}\footnote{a green-sapped
  stick, 绿干枝。sapped有一个较少用到的意思，to drain the sap from sth, 把树
  的汁液排干。} so that any pull or touch on the bait would make the stick
dip and each line had two forty-fathom coils which could be made
fast\footnote{\footnote{这里的fast是古旧用法，表示 ``securely attached/
    firmly tied'' “牢固绑定，系牢的”意思。后文还会多次出现。} } to the
other \gls{spare} coils so that, if it were necessary, a fish could take out
...
made it fast to a ring \gls{bolt} in the stern. Then he baited another line
and left it coiled in the shade of the bow. He went back to rowing and to
watching\footnote{go back to中的to为介词，后接名词、代词或现在分词。} the
...
blue now, so dark that it was almost purple. As he \uline{looked down into it}
...
with the \gls{horny} \gls{soles} of his feet.
...
there was no scattering of bait fish. But as the old man watched, a small
tuna rose in the air, turned and dropped head first into the water. The tuna
\gls{shone} \gls{silver} in the sun and after he had dropped back into the
water another and another rose and they were jumping in all
\glspl{direction}, \gls{churning} the water and \gls{leaping} in long jumps
...
dropped his oars and felt the weight of the small tuna's \gls{shivering}
...
quick shivering \gls{strokes} of his \gls{neat}, fast-moving tail. The old
...
considered it so and \gls{respected} it. But now he said his thoughts
\gls{aloud} many times since there was no one that they could annoy.
...
\glspl{fleck} of the plankton were annulled now by the high sun and it was
only the great deep prisms in the blue water that the old man saw now with
his lines going straight down into the water that was a mile deep.
...
\gls{toe} to wake me. But today is eighty-five days and I should fish the day
well.
...
and \gls{forefinger} of his right hand. He felt no \gls{strain} nor weight
and he held the line lightly. Then it came again. This time it was a
\gls{tentative} pull, not \gls{solid} nor heavy, and he knew exactly what it
was. One hundred fathoms down a \gls{marlin} was eating the sardines that
covered the point and the shank of the hook where the hand-\gls{forged} hook
...
He let the line slip through his fingers while he \uline{reached down
  with his left hand}\footnote{放低他的左手。} and made fast the free end of
the two reserve coils to the loop of the two reserve coils of the next line.
Now he was ready. He had three forty-fathom coils of line in reserve now, as
...
held it against his back until it was so \gls{taut} that \glspl{bead} of
...
``I wish I had the boy'' the old man said aloud. ``I'm being towed by a fish
and I'm the towing \gls{bitt}. I could make the line fast. But then he could
break it. I must hold him all I can and give him line when he must have it.
...
and it was cutting his forehead. He was thirsty too and he got down on his
knees and, being careful not to \gls{jerk} on the line, moved as far into
the bow as he could get and reached the water bottle with one hand. He
opened it and drank a little. Then he rested against the bow. He rested
sitting on the \gls{un-stepped} mast and sail and tried not to think but only to
\gls{endure}.
...
The fish never changed his \gls{course} nor his direction all that night
...
went down and the old man's \gls{sweat} dried cold\footnote{cold在动词dried之
...
the bow so that he was almost comfortable. The position actually was only
...
\gls{unavoidable}. I must remember to eat the tuna before he \glspl{spoil} in
order to keep strong. Remember, no matter how little you want to, that you
must eat him in the morning. Remember, he said to himself.

During the night two \gls{porpoises} came around the boat and he could hear
them \gls{rolling} and \gls{blowing}. He could tell the difference between
the blowing noise the \gls{male} made and the sighing blow of the \gls{female}.
...
strong fish nor one who \gls{acted} so strangely. Perhaps he is too
...
\uline{cannot} know that it is only one man against him, \uline{nor} that it is an
old man. But what a great fish he is and what will he bring in the market if
the flesh is good. He took the bait like a male and he pulls like a male and
his fight has no panic in it. I wonder if he has any plans or if he is just
as \gls{desperate} as I am?
...
line and he \gls{teetered} on it as his delicate feet \gls{gripped} it fast.
...
``Stay at my house if you like, bird,'' he said. ``I am sorry I cannot hoist
the sail and take you in with the small breeze that is rising. But I am with
a friend.''
...
``I wish the boy were here and that I had some salt,''\footnote{第三人称单
  数the boy后使用were，而非was，是were过去虚拟语气，这里老人已经明确小孩不会
  在这里，只是梦想。与前面的wish the boy was here形成情绪上的起伏。} he said
aloud. Shifting the weight of the line to his left shoulder and \gls{kneel}ing
carefully he washed his hand in the ocean and held it there, \gls{submerged}, for
more than a minute watching the blood trail away and the steady movement of
the water against his hand as the boat moved.
...
of the bow, \gls{wiped} his knife on his trousers, and lifted the carcass of the
...
He \uline{rubbed} the cramped hand against his trousers and tried to gentle the
...
wind\footnote{trade wind, 信风﹐贸易风（指从东北或东南方向吹向赤道的热带
  风）。} and he looked ahead and saw a \gls{flight} of wild ducks etching
...
weather of hurricane months is the best of all the year.
...
\glspl{pile} of ice cream and high above were the thin \glspl{feather} of
the \glspl{cirrus} against the high September sky.

``Light brisa\footnote{原文为西班牙语“微风”。},'' he said. ``Better
...
thought of it as a calambre\footnote{西班牙语“抽筋”}, humiliates oneself
...
never alone. Now alone, and out of sight of land, he was fast to the biggest fish \uline{that he had ever seen and bigger
  than he had ever heard of}, and his left hand was still as tight as the
gripped claws of an eagle.
...
him what sort of man I am. But then he would see the cramped hand. Let him
...
ten Hail Marys{十遍天主经和十遍万福玛利亚经} that I should catch this fish,
...
Yankees of New York were playing the Tigres\footnote{西班牙语，“老虎”。} of Detroit.
...
could not and it stayed at the \gls{hardness} and \gls{water-drop}
...
its \gls{merits}. I may lose so much line that I will lose him, if he makes
...
coils of line that he could not see. There was plenty of line still and now
...
a small line out with a \gls{spoon} on it and try and get something to eat
...
bringing him in? If I were \gls{towing} him behind there would be no
...
maybe I can get him. Dentuso\footnote{西班牙语，意思为“牙齿锋利的”，这是当
...
the bad time is coming and I do not even have the harpoon. The dentuso is
...
But you enjoyed killing the dentuso, he thought. He lives on\footnote{live
...
``Ay,'' he said aloud. There is no \gls{translation} for this word and
...
``Galanos\footnote{西班牙语，可能是加拉帕戈斯真鲨，别名直翅真鲨。},'' he
...
\gls{tipped} wide pectoral fins. They were \gls{hateful} sharks, bad
...
loose, he said, ``Go on, galano. \Gls{slide} down a mile deep. Go see your friend,
...
under-side of the fish. He knew that each of the \gls{jerking} \glspl{bump}
...
He \gls{spat} into the ocean and said, ``Eat that, galanos. And make a dream
you've killed a man.''
...
in the water \uline{among the empty beer cans and dead \gls{barracudas}} a
...
``Tiburon\footnote{西班牙语，意为“鲨鱼”。},'' the waiter said.
