...
\gls{royal_palm} which are called \emph{guano}\footnote{royal palm的西班牙语。} and
...
\gls{overlapping} leaves of the \gls{sturdy} \gls{fibered} \emph{guano} there was a
...
never carried a lunch. He had a bottle of water in the \gls{bow} of the
...
fishermen called the great well because there was a \gls{sudden} deep of
seven hundred \glspl{fathom} where all sorts of fish \gls{congregated}
because of \uline{the \gls{swirl} the current made} against the \gls{steep} walls of
