...
\setmathfont[Scale = 1.15]{TeX Gyre Pagella Math}  % 因Libertinus目前的数学字体暂还没
% 有粗体，这里设置为允许伪粗体渲染。

\setmainfont[Scale=1.15]{Libertinus Serif}
\setsansfont[Scale=1.15]{TeX Gyre Heros}
...
% 断字的数量受\hyphenpenalty的影响，将其设置为10000几乎可以防止断字。由于这会
% 产生单词之间有更多空间的行，因此应该增加LaTeX的\tolerance。
\hyphenpenalty=5000
\tolerance=1000
...
\setcolumnwidth{0.54\textwidth,0.43\textwidth}
